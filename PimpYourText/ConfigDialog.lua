...
function ConfigDialog:BuildBloc(parent)
	...
	optDiversTitleLabel:SetText(_("CONFIG1"));
	...
	defaultButton:SetText(_("CONFIG_DEFAULT"));
	...
	canMoveQuicklauncherCheckbox:SetText( _("CONFIG_MOUSE") );
	...
	useQuickLauncherCheckbox:SetText( _("CONFIG_SHOWLAUNCHER") );
	...
	autoShowOnLaunchCheckbox:SetText( _("CONFIG_SHOWWINDOW") );
	...
	animateQuickLaunchCheckbox:SetText( _("CONFIG_ANIMATE") );
	...
	opacityLabel:SetSize( 360, 20 );
	opacityLabel:SetText( _("CONFIG_OPACITY") );
	...
	showClosingMessageCheckbox:SetText( _("CONFIG_SHOWCLOSMSG") );
