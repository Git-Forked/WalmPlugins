...
function DropDown.Create(ListTable,Default)
	...
	listBOXParent:SetBackColor(Turbine.UI.Color(0.13,0.13,0.13));
	...
	listBOX:SetBackColor(Turbine.UI.Color(0.0,0,0,0));
	...
	listScroll:SetZOrder(199000);
	listScroll:SetBackColor(Turbine.UI.Color(0.0,0.0,0.0));
