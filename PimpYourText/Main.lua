import "WalmPlugins.PimpYourText.Turbine";

import "WalmPlugins.PimpYourText.PimpYourText";
import "WalmPlugins.PimpYourText.QuickLauncher";
import "WalmPlugins.PimpYourText.Saving";
import "WalmPlugins.PimpYourText.ConfigDialog";
import "WalmPlugins.PimpYourText.Translate";
...
function Savesettings()
	function SavesettingsConfirmation(sender, args)
		Turbine.Shell.WriteLine(_("SAVE_OK"));
	end
...
optionsButton:SetText(_("OPEN_CONFIG"));
...
pimpYourTxtDlg = PimpYourTextDialog();
